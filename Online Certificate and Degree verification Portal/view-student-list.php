...
<html> 
	<head> 
		...
		<title> Verified Certificate List</title>
	...
	<body> 
			...
			<nav class="navbar navbar-default navbar-fixed-top">
			  <div class="container">
				<div class="navbar-header">
				  ...
				  <a class="navbar-brand" href="#"> <strong>Online Certificate Verification</strong> </a>
				</div>
		...
		<footer class="footer">
			<div class="container">
				<p> &copy;Copyrights:<?php echo date("Y"); ?> <br />All Rights Reserved By <strong> <i>Rohitash Bishnoi</i> </strong></p>
			</div>
		</footer>
